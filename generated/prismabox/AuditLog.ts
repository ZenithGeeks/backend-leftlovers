...
export const AuditLogPlainInputCreate = t.Object(
  {
    action: t.String(),
    targetType: t.String(),
    meta: t.Optional(__nullable__(t.Any())),
  },
  { additionalProperties: false },
);
  ...
  t.Object(
    {
      ...
      targetType: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      targetId: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      meta: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
